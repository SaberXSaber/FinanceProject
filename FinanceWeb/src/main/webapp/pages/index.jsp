...
<div id="wrapper">
      ...
      <ul class="nav" id="side-menu">
        ...
        <li>
          ...
          <ul class="nav nav-second-level">
            <li>
              <a class="J_menuItem" href="/fund/list">基金</a>
            </li>
            <li>
              <a class="J_menuItem" href="/shares/list">股票</a>
            </li>
            <li>
  ...
  <div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <div class="row J_mainContent" id="content-main">
      <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/fund/list" frameborder="0" data-id="index_v1.html" seamless></iframe>
    </div>
    <%--<div class="footer">
